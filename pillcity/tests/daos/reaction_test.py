...
from pillcity.daos.reaction import create_reaction, delete_reaction, get_reaction
from pillcity.daos.exceptions import UnauthorizedAccess, NotFound, BadRequest
...
class ReactionTest(BaseTestCase):
    def test_react_twice(self):
        ...
        # Create post
        create_post(user1, 'post1', True, [], False, None, [], [], False, [], [], None)
